...
namespace AbrasNigeria.Migrations.PartsBookDb
{
    ...
    partial class PartsBookDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("AbrasNigeria.Models.Description", b =>
                {
                    ...
                    b.HasIndex("DescriptionName")
                        .IsUnique()
                        .HasFilter("[DescriptionName] IS NOT NULL");
            ...
            modelBuilder.Entity("AbrasNigeria.Models.SectionGroup", b =>
                {
                    ...
                    b.HasIndex("SectionGroupName")
                        .IsUnique()
                        .HasFilter("[SectionGroupName] IS NOT NULL");
